...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210507_cguide_e8e2df55df1765e69223_20210507035627_archive.zip';
	const ARCHIVE_SIZE		 = '995273826';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e8e2df5-07035627';
    const SECONDARY_PACKAGE_HASH = 'e689914-07035627';
	const VERSION			 = '1.4.0';
